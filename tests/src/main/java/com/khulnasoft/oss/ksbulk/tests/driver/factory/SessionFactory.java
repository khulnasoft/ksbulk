 ...
 */
package com.khulnasoft.oss.ksbulk.tests.driver.factory;

import static com.khulnasoft.dse.driver.api.core.config.DseDriverOption.GRAPH_SUB_PROTOCOL;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.AUTH_PROVIDER_CLASS;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.AUTH_PROVIDER_PASSWORD;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.AUTH_PROVIDER_USER_NAME;
...
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.CONTROL_CONNECTION_AGREEMENT_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.CONTROL_CONNECTION_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.HEARTBEAT_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.LOAD_BALANCING_LOCAL_DATACENTER;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.METADATA_SCHEMA_REQUEST_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_ADMIN_SHUTDOWN_QUIET_PERIOD;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_ADMIN_SHUTDOWN_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_ADMIN_SHUTDOWN_UNIT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_IO_SHUTDOWN_QUIET_PERIOD;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_IO_SHUTDOWN_TIMEOUT;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.NETTY_IO_SHUTDOWN_UNIT;
...
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_ENGINE_FACTORY_CLASS;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_HOSTNAME_VALIDATION;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_KEYSTORE_PASSWORD;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_KEYSTORE_PATH;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_TRUSTSTORE_PASSWORD;
import static com.khulnasoft.oss.driver.api.core.config.DefaultDriverOption.SSL_TRUSTSTORE_PATH;
...
import com.khulnasoft.oss.driver.api.core.config.ProgrammaticDriverConfigLoaderBuilder;
...
import com.khulnasoft.oss.ksbulk.tests.driver.annotations.SessionFactoryMethod;
import com.khulnasoft.oss.ksbulk.tests.utils.ReflectionUtils;
import com.khulnasoft.oss.ksbulk.tests.utils.SessionUtils;
  ...
  private static class SessionMethodFactory extends SessionFactory {
    ...
    private static Method locateSessionFactoryMethod(
      ...
      if (method.getAnnotation(
              com.khulnasoft.oss.ksbulk.tests.driver.annotations.SessionFactory.class)
          == null) {
        throw new IllegalArgumentException(

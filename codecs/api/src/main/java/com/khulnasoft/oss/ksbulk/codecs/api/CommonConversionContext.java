...
/**
 * A collection of most common conversion context attributes used in KSBulk and other projects.
 * These settings can be reused and extended by modules depending on the ksbulk-codec-api module.
 */
public class CommonConversionContext extends ConversionContext {
   ...
   * mode, KSBulk behaves as follows: when loading, if the target CQL type is textual (i.e. text,
   ...
   *
   * <p>Note that, regardless of this setting, KSBulk will always convert empty strings to {@code

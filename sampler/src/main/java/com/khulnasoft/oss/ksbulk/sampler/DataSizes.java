...
import com.khulnasoft.oss.driver.api.core.data.GettableByIndex;
import com.khulnasoft.oss.driver.api.core.type.codec.registry.CodecRegistry;
import com.khulnasoft.oss.driver.internal.core.cql.Conversions;
...
public class DataSizes {
   ...
   * href="https://docs.khulnasoft.com/en/dse/6.0/dse-dev/khulnasoft_enterprise/config/configCassandra_yaml.html#configCassandra_yaml__advProps">cassandra.yaml
   ...
   * com.khulnasoft.oss.driver.internal.core.util.Sizes Sizes} class; this method attempts to guess

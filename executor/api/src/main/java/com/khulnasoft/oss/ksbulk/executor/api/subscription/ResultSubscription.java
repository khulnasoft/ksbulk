...
import com.khulnasoft.oss.driver.api.core.AsyncPagingIterable;
...
import com.khulnasoft.oss.ksbulk.executor.api.listener.DefaultExecutionContext;
 ...
 *
 * @param <P> the page type, one of {@link com.khulnasoft.oss.driver.api.core.cql.AsyncResultSet
 *     AsyncResultSet} or {@link
 *     com.khulnasoft.dse.driver.api.core.cql.continuous.ContinuousAsyncResultSet
 *     ContinuousAsyncResultSet}.
 * @param <R> the result type ({@link WriteResult} or {@link ReadResult}).
 */

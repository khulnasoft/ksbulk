...
- [improvement] [#398](https://github.com/khulnasoft/ksbulk/issues/398): Support reading records from AWS S3.
- [new feature] [#481](https://github.com/khulnasoft/ksbulk/issues/481): Add support for loading/unloading vector type data

## 1.10.0

- [improvement] Upgrade driver to 4.14.1.
- [improvement] [#423](https://github.com/khulnasoft/ksbulk/issues/423): Upgrade driver to 4.14.1, and other KSBulk dependencies.
- [bug] [#419](https://github.com/khulnasoft/ksbulk/issues/419): Fix wrong ANSI mode option name.
- [bug] [#425](https://github.com/khulnasoft/ksbulk/issues/425): Don't print count results if read result counter is null.
- [improvement] [#424](https://github.com/khulnasoft/ksbulk/issues/424): Add "max" verbosity level for debugging purposes.
- [new feature] [#429](https://github.com/khulnasoft/ksbulk/issues/429): Produce a positions file when unloading / counting.
- [improvement] [#437](https://github.com/khulnasoft/ksbulk/issues/437): Add building instructions to CONTRIBUTING.md.
- [improvement] [#438](https://github.com/khulnasoft/ksbulk/issues/438): Ability to limit throughput in bytes per second.
- [bug] [#440](https://github.com/khulnasoft/ksbulk/issues/440): Properly close files when unload is interrupted.
- [bug] [#444](https://github.com/khulnasoft/ksbulk/issues/444): Increment records/failed counter for failed writes.
- [new feature] [#431](https://github.com/khulnasoft/ksbulk/issues/431): Ability to resume a failed operation.

## 1.9.1

- [improvement] [#435](https://github.com/khulnasoft/ksbulk/issues/435): Auto-detect cloud server-side rate-limit.

## 1.9.0

- [improvement] Upgrade driver to 4.14.0.
- [new feature] [#400](https://github.com/khulnasoft/ksbulk/issues/400): Add ability to unwrap BATCH queries.
- [new feature] [#405](https://github.com/khulnasoft/ksbulk/issues/405): Add support for Prometheus.
- [improvement] [#403](https://github.com/khulnasoft/ksbulk/issues/403): Exclude unsupported types from automatic timestamp and TTL preservation.
- [improvement] [#402](https://github.com/khulnasoft/ksbulk/issues/402): Upload KSBulk binary distributions to Maven Central.
- [improvement] [#411](https://github.com/khulnasoft/ksbulk/issues/411): Don't check for emptiness of primary key columns.
- [improvement] [#412](https://github.com/khulnasoft/ksbulk/issues/412): Add support for nested functions in mappings.
- [improvement] [#415](https://github.com/khulnasoft/ksbulk/issues/415): Add support for literals in mappings.
...
- [bug] DAT-627: Share CodecRegistry instance between KSBulk and driver.
...
- [improvement] DAT-525: Update KSBulk to unified driver.
- [new feature] DAT-354: Add support for DSE Graph to KSBulk.
...
- [new feature] DAT-519: Remove restriction preventing KSBulk use with OSS Cassandra.


## 1.4.0

- [improvement] DAT-303: Update KSBulk to Java DSE Driver 2.x.
- [new feature] DAT-449: Add support for loading and unloading from/to compressed files.
- [new feature] DAT-412: Add support for KhulnaSoft Cloud.
...
- [bug] DAT-414: KSBulk should allow INSERT queries without clustering column when all columns are static.
- [improvement] DAT-411: Improve error message when row fails to decode.
- [improvement] DAT-383: Show version option in KSBulk help.
...
- [bug] DAT-427: KSBulk should handle empty column names in CSV headers.
- [bug] DAT-427: KSBulk should handle empty or duplicate column names in CSV headers.
...
- [improvement] DAT-336: Extend KSBulk's rate limiting capability to reads.
...
- [improvement] DAT-305: KSBulk help should show description of available commands.
...
- [bug] DAT-326: KSBulk fails when mapping contains a primary key column mapped to a function.


### 1.1.0

- [bug] DAT-289: Generated queries do not respect indexed mapping order.
- [bug] DAT-288: KSBulk cannot handle columns of type list<timestamp>.
- [improvement] DAT-292: Add support for counter tables.
- [bug] DAT-295: Generated query does not always contain all token ranges.
- [bug] DAT-297: Empty map values do not work when loading using KSBulk.
...
- [bug] DAT-300: KSBulk fails to start with Java 10+.
- [improvement] DAT-290: KSBulk should avoid logging to stdout.
...
- [improvement] DAT-243: Improve message when KSBulk completes with errors.
...
- [improvement] DAT-183: Add code coverage to KSBulk builds.
...
- [improvement] DAT-187: Change default for driver.auth.principal from user@KHULNASOFT.COM to unspecified.
...
- [improvement] DAT-200: KSBulk should fail if execution directory already exists and is not empty.
...
- [improvement] DAT-180: Improve KSBulk exit statuses.
- [improvement] DAT-213: Create examples for connector.json.parserFeatures and connector.json.generatorFeatures.
- [improvement] DAT-216: application.conf and application.template.conf should include ksbulk element wrapping.
...
- [improvement] DAT-155: Make ksbulk script more friendly for use in a DSE installation.
...
- [improvement] DAT-88: Rename modules and packages to ksbulk.

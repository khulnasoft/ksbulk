...
public class NetworkUtils {
   ...
   * com.khulnasoft.oss.ksbulk.tests.utils.DEFAULT_IP_PREFIX}.
   */
  public static final String DEFAULT_IP_PREFIX =
      System.getProperty("com.khulnasoft.oss.ksbulk.tests.utils.DEFAULT_IP_PREFIX", "127.0.0.");
   ...
   * remote cluster, e.g. when building a {@code Session} instance with the KhulnaSoft Java driver.
   *
   * @param ipPrefix The IP prefix to use (e.g. {@code 127.0.1.}).
   * @param nodesPerDC the number of nodes in each DC.

...
import com.khulnasoft.dse.driver.api.core.graph.GraphResultSet;
import com.khulnasoft.dse.driver.api.core.graph.ScriptGraphStatement;
...
import com.khulnasoft.oss.ksbulk.tests.assertions.TestAssertions;
...
class GraphEndToEndCCMIT extends EndToEndCCMITBase {
  ...
  void json_full_load_unload_and_load_again_vertices() throws Exception {
    ...
    List<String> args =
        com.khulnasoft.oss.driver.shaded.guava.common.collect.Lists.newArrayList(
            "load",
            "-g",
            FRAUD_GRAPH,
            "-v",

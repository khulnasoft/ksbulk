...
public interface CCMCluster extends Closeable {
   ...
   * href="http://docs.khulnasoft.com/en/cassandra/3.x/cassandra/configuration/configCassandra_yaml.html?scroll=configCassandra_yaml__native_transport_port"
   ...
   * remote cluster, e.g. when building a {@code Cluster} instance with the KhulnaSoft Java driver.
   *
   ...
   * href="http://docs.khulnasoft.com/en/cassandra/3.x/cassandra/configuration/configCassandra_yaml.html?scroll=configCassandra_yaml__storage_port"
   ...
   * href="http://docs.khulnasoft.com/en/cassandra/3.x/cassandra/configuration/configCassandra_yaml.html?scroll=configCassandra_yaml__rpc_port"

 ...
 */
package com.khulnasoft.oss.ksbulk.workflow.commons.policies.lbp;
...
import com.khulnasoft.oss.driver.api.core.loadbalancing.NodeDistanceEvaluator;
import com.khulnasoft.oss.driver.api.core.metadata.EndPoint;
import com.khulnasoft.oss.driver.api.core.metadata.Node;
import com.khulnasoft.oss.driver.internal.core.ContactPoints;
 ...
 *
 * <p>This evaluator is not compatible with KhulnaSoft Astra cloud deployments.
 *
...
public class SimpleNodeDistanceEvaluator implements NodeDistanceEvaluator {
   ...
   * @param profileName The execution profile name; for KSBulk, this should always be the default
   *     profile name.
   */

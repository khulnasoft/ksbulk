...
import com.khulnasoft.oss.driver.shaded.guava.common.util.concurrent.ThreadFactoryBuilder;
  ...
  public void init() {
    try {
      ...
      if (reportRate.getSeconds() == 0) {
        LOGGER.warn(
            "Invalid value for ksbulk.monitoring.{}: expecting duration >= 1 second, got '{}' – will use 1 second instead",
            REPORT_RATE,
      ...
      throw ConfigUtils.convertConfigException(e, "ksbulk.monitoring");
    }
  }

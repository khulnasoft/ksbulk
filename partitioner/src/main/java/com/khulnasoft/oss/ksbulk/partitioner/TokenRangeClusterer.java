...
import com.khulnasoft.oss.driver.shaded.guava.common.collect.ComparisonChain;
...
public class TokenRangeClusterer {
   ...
   *
   * <p>Note: the grouping algorithm used in KSBulk is different from the one used by the Spark

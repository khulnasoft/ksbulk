...
public class WorkflowUtils {
  ...
  public static final String BULK_LOADER_APPLICATION_NAME = "KhulnaSoft Bulk Loader";
  ...
  public static String getBulkLoaderVersion() {
    // Get the version of ksbulk from version.txt.
    String version = "UNKNOWN";
    try (InputStream versionStream =
        ConsoleUtils.class.getResourceAsStream("/com/khulnasoft/oss/ksbulk/version.txt")) {
